...
<div class="content-wrapper gso-dashboard">
        ...
        function renderInfoBox($link, $icon, $title, $metricKey, $description, $color) {
          $safeKey = htmlspecialchars($metricKey, ENT_QUOTES);
                    ...
                    $safeColor = preg_replace('/[^a-z0-9\-]/i', '', (string)$color);
	                            ...
	                            <div class='col-lg-4 col-md-6 mb-3'>
	                                <a href='{$safeLink}' class='gso-stat-link' aria-label='More information about {$safeTitle}'>
	                                    <div class='gso-stat-card'>
	                                        <div class='gso-stat-icon gso-stat-icon--{$safeColor}'><i class='fa-solid {$icon}'></i></div>
                                        <div>
	                    ...
	                    <div class="card gso-card">
	                        <div class="card-header border-0">
	                            <div class="d-flex justify-content-between align-items-center">
	                                <h3 class="card-title mb-0">Clearance Release Analytics</h3>
	                            ...
	                            <div class="row">
	                                <div class="col-12">
	                                    <div class="position-relative" style="min-height: 420px;">
	                                        <canvas id="dashboardClearanceMonthlyChart" height="140"></canvas>
	                                    </div>
	                                    <div class="text-muted mt-2" id="dashboardClearanceSummary" style="font-size: 13px;"></div>
	                                </div>
	                            </div>
	                        </div>
	                    </div>
