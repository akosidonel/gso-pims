      ...
      <div class="card"> <!-- Default box -->
        <div class="card-header">
          ...
          <div class="card-tools">
            <button type="button" class="btn btn-block bg-gradient-success btn-sm"  data-toggle="modal" data-target="#addAccntModal"> <i class="fas fa-book"></i>&nbsp; Add Account Code</button> 
       ...
       <div class="modal fade" id="editAccntModal">
        ...
        <div class="card-body">
          <div id="gfAccountCodePage" data-default-category="PAR"></div>

          <div class="d-flex align-items-center justify-content-between mb-3" style="gap:12px;">
            <ul class="nav nav-tabs" id="gfAcctCategoryTabs" role="tablist">
              <li class="nav-item">
            ...
            <div class="text-muted">
              <span id="reportTitle" class="d-none">General Fund Account Code</span>
              <small>TOTAL AMOUNT:&nbsp;<b id="gfAcctCategoryTotal">₱ 0.00</b></small>
            </div>
          </div>

        <table id="dataTable" data-dt-custom="gfAccountCodes" class="table table-bordered table-hover">
                  <thead>
