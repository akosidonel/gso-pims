...
<head>
  ...
  <?php
    $needsPremiumTheme = in_array($currentPage, ['dashboard.php', 'disposal.php', 'disposal-items.php', 'unserviceable.php', 'add-return.php', 'add-item.php', 'add-infrastructure.php', 'add-land.php', 'general-fund-department.php', 'general-fund-inventory.php', 'sef-institution.php', 'sef-inventory.php', 'new-purchase-items.php'], true);
  ?>
